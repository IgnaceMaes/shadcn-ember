...
describe("require-as-child-props", () => {
  ...
  const valid = [
    ...
    '<Button @asChild={{true}} as |buttonClasses|><LinkTo @route="index" class={{buttonClasses}}>Login</LinkTo></Button>',
    '<Button @asChild={{true}} as |buttonClasses|><LinkTo @route="index" class="{{buttonClasses}} w-full">Login</LinkTo></Button>',
    ...
    '<DropdownMenuItem @asChild={{true}} as |classes|><a href="/accounts/logout/" class={{classes}}>Profile</a></DropdownMenuItem>',
